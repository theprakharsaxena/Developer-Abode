        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          {Faq1.map(
            (
              ...
              return (
                <div className="m-5 sm:m-10 p-10 bg-black border-2 relative border-blue-500 rounded-xl" key={id}>
                  <h1 className="text-blue-500 text-xl sm:text-2xl md:text-3xl font-mono font-bold underline underline-offset-4 mb-5">
                    {title}
                  </h1>
                  <p className={`text-white sm:text-lg md:text-xl mb-10 ${textposition}`}>
                    {description}
                  </p>
